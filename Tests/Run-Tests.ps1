<#
.SYNOPSIS
    Automated Test Runner for RackStack v1.95.0
...
try {
    ...
    Write-TestResult "50-EntryPoint: action list has 168 entries" ($listActionCount -eq 168) "Found $listActionCount"
} catch {
...
try {
    ...
    Write-TestResult "50-EntryPoint: action list has 168 entries" ($actionCount2 -eq 168) "Found $actionCount2"
} catch {
...
try {
    ...
    Write-TestResult "50-EntryPoint: action list has 168 entries" ($actionCount3 -eq 168) "Found $actionCount3"
} catch {
...
try {
    ...
    Write-TestResult "50-EntryPoint: action list has 168 entries" ($actionCount4 -eq 168) "Found $actionCount4"
} catch {
