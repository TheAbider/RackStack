...
$script:FavoriteDispatch = @{
    ...
    "Set IP Address"             = "Set-VMIPAddress"
    "Set DNS"                    = "Set-VMDNSAddress"
    "Set Hostname"               = "Set-Hostname"
    "Join Domain"                = "Join-Domain"
    "Install Hyper-V"            = "Install-HyperVRole"
    "Install MPIO"               = "Install-MPIOFeature"
    "Enable RDP"                 = "Enable-RDP"
    "Enable WinRM"               = "Enable-PowerShellRemoting"
    "Configure Firewall"         = "Disable-WindowsFirewallDomainPrivate"
    "Defender Exclusions"        = "Set-DefenderExclusions"
    "Add Local Admin"            = "Add-LocalAdminAccount"
    ...
    "License Server"             = "Show-LicenseStatus"
    "Set Power Plan"             = "Set-ServerPowerPlan"
    "Storage Manager"            = "Show-StorageManagerMenu"
    "BitLocker Management"       = "Show-BitLockerManagement"
